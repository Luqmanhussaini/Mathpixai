        ...
        <div>
            ...
            <div className='container disp'>
                <div className='inside_padding'>
                    ...
                    <div className="three_btns">
                        <div class="p-2"><button type="button" class="btn btn-lg btn-primary">Request a quote</button></div>
                        <div class="p-2"><button type="button" class="btn btn-lg btn-outline-secondary">Learn more</button></div>
                    </div>
                </div>
            </div>
            <div className="bigimg">
            <img src="https://mathpix.com/images/snip-page/scs.webp" width={900} height={408} alt="" />
            </div>
        </div >
    )
}